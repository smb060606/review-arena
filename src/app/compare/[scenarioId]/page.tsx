          ...
          <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-5">
              ...
              <div className="flex items-end gap-4 mb-4">
                <div>
                  ...
                  <div className="flex rounded-lg border border-[var(--border)] overflow-hidden">
                    ...
                    <button
                      disabled
                      className="px-4 py-2 text-sm font-medium bg-[var(--muted)] text-[var(--muted-foreground)] opacity-40 cursor-not-allowed"
                      title="OpenAI API key not configured yet"
                    >
                      GPT-5.5 (OpenAI) — Coming soon
                    </button>
                  </div>
                </div>
                <button
            ...
            {loadingAnalysis && (
              <div className="text-[var(--muted-foreground)] text-center py-8">
                Analyzing findings from both tools using {selectedProvider === "anthropic" ? "Claude Opus 4.7" : "GPT-5.5"}... This may take 30-60 seconds.
              </div>
            )}
            ...
            {analysis && (
              <div className="space-y-6">
                <div className="text-xs text-[var(--muted-foreground)] bg-[var(--muted)] px-3 py-1.5 rounded-lg inline-block">
                  Analysis generated by {analysis.analyzedBy === "anthropic" ? "Claude Opus 4.7 (Anthropic)" : "GPT-5.5 (OpenAI)"}
                </div>

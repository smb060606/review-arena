...
export default function ComparePage() {
  ...
  async function handleAnalyze() {
    ...
    try {
      const res = await fetch(`/api/reviews/analyze/${scenarioId}`, { method: "POST" });
        ...
        <>
          ...
          <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-5">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-semibold">AI-Generated Neutral Analysis</h3>
              {!analysis && (
                <button
            ...
            {loadingAnalysis && (
              <div className="text-[var(--muted-foreground)] text-center py-8">
                Analyzing findings from both tools... This may take 30-60 seconds.
              </div>
            )}
